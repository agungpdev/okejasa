...
<div class="page-header d-print-none">
    <div class="container-xl">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
            <a href="#" class="btn btn-indigo d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#modal-kategori">
                            ...
                            <table id="table-kategori" class="table is-striped is-hoverable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="text-muted"><a href="#" id="permission" class="text-reset" data-roles="" data-bs-toggle="modal" data-bs-target="#modal-permission">10</a></td>
                                  <td class="text-muted">{{$val->created_at}}</td>
                                  <td><a href="" class="btnedit" data-bs-toggle="modal" data-bs-target="#modal-edit" data-kategori="{{encrypt($val->id)}}">Edit</a> | <a href="" class="text-danger btndelete" data-kategori="{{encrypt($val->id)}}">Delete</a></td>
                                </tr>
                                @endforeach
                              </tbody>
                            </table>
    ...
    $(document).ready(function(){
        ...
        $(document).on('submit','#tambah-kategori',function(e){
            ...
            $.ajax({
                ...
                contentType: false,
                type: 'POST',
                url:'{{route('dashboardtokokategori.store')}}',
                beforeSend: function() {
...
@section('modal')
    @include('dashboard.modals._kategorimodal')
